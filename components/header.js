        ...
        <>
            <header className="header-site">
                <div className={menu}>
                    <div className="profile">
                        <div className="background">
                            <img src="/images/background.jpeg" className="responsive-img" alt="Avatar del usuario"/>
                        </div>
                        <div className="user-info">
                            <div className="avatar">
                                <img src="/images/minecraft.jpg" alt="Avatar del usuario"/>
                            </div>
                ...
                <div className="header-visible">
                    <button className="btn-menu" onClick={ toggleMenu }><i className="material-icons">menu</i></button>
                </div>
            </header>
